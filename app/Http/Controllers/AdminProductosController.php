<?php namespace App\Http\Controllers;
	...
	class AdminProductosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Precio de Costo","name"=>"precioCosto"];
			$this->col[] = ["label"=>"Numero de Puntos","name"=>"numPuntos"];
			...
			$this->form[] = ['label'=>'Precio de Costo','name'=>'precioCosto','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Numero de Puntos','name'=>'numPuntos','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"PrecioCosto","name"=>"precioCosto","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"NumPuntos","name"=>"numPuntos","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
